...
static LPCSTR message_to_string(const UINT message)
{
	switch (message) {
...
//	case WM_GESTURENOTIFY: return "WM_GESTURENOTIFY";
	...
	case STM_SETICON: return "STM_SETICON";
	case STM_GETICON: return "STM_GETICON";
	case STM_SETIMAGE: return "STM_SETIMAGE";
	case STM_GETIMAGE: return "STM_GETIMAGE";
	case STM_MSGMAX: return "STM_MSGMAX";
...
static void print_message(const UINT message) {
	...
	goDebugMessage((unsigned long)message, (char*)msg);
}
