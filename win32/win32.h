...
/*
extern void g2d_win32_free(void *data);
extern void g2d_win32_to_tstr(void **str, void *go_cstr, size_t length, int *err_num);
*/
extern void g2d_win32_init(void **e, void **d, void **f, int d_len, int *max_t_size, int *err_num, g2d_ul_t *err_win32);
